...
import { FiPlus, FiEdit, FiTrash2, FiCheck, FiX, FiRefreshCw, FiPackage, FiMessageSquare, FiBox } from 'react-icons/fi';
                ...
                <div className="w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl"
                  ...
                  <form onSubmit={handleProdSubmit} className="p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div><Lbl c="Category"/><select className="input-field" value={prodForm.category} onChange={e=>setProdForm({...prodForm,category:e.target.value})}>{CATS.map(c=><option key={c}>{c}</option>)}</select></div>
